...
class PortfolioManager:
    ...
    def update(
        ...
        return self._handle_existing_portfolio(
            state,
            rankings,
            rebalance_date,
            is_rebalance_day,
    ...
    def _handle_existing_portfolio(
        self,
        state: PortfolioState,
        rankings,
        rebalance_date,
        ...
        if is_rebalance_day:
            ...
            portfolio = self._process_daily_portfolio(
                state.portfolio,
                rankings,
                rebalance_date,
            )
    ...
    def _process_daily_portfolio(
        self,
        portfolio,
        rankings,
        rebalance_date,
    ):
        # Build rank_lookup as in rebalance_existing_portfolio
        rank_lookup = {
        ...
        # Process existing holdings (no replacement buys)
        (
            kept_holdings,
            held_symbols,
            available_cash,
            total_sell_proceeds,
            period_realized_pnl,
        ) = self._process_existing_holdings(
            portfolio,
            rank_lookup,
            sell_rank,
            rebalance_date,
        ...
        # No replacement buys, just keep whatever remains and update weights
        self._update_weights(kept_holdings)
    ...
    def _process_existing_holdings(
        self,
        portfolio,
        rank_lookup,
        sell_rank,
